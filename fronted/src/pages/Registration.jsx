    ...
    return (
        <div className='w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-[white] flex flex-col items-center justify-start'>
            ...
            <div className='max-w-[600px] w-[90%] h-[500px] bg-[#00000025] border-[1px] border-[#96969635] backdrop:blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
               <form action="" className='w-[90%] h-[500px] flex flex-col items-center justify-start gap-[20px]' onSubmit={handleSubmit}>
                ...
                <div className='w-[90%] h-[400px] flex flex-col items-center justify-center gap-[15px] relative'>
                 <input type="text" placeholder='Enter your name' className='w-[100%] h-[50px] border-[2px] border-[#96969635] backdrop:blur-sm rounded-lg shadow-lg bg-transparent placeholder-[#ffffffc7] px-[20px] font-semibold' onChange={(e)=>setName(e.target.value)} required/>
                  ...
                  <input type="text" placeholder='Enter your email' className='w-[100%] h-[50px] border-[2px] border-[#96969635] backdrop:blur-sm rounded-lg shadow-lg bg-transparent placeholder-[#ffffffc7] px-[20px] font-semibold' onChange={(e)=>setEmail(e.target.value)} required/>
                   ...
                   {!show &&<FaRegEye className='w-[20px] absolute right-[5%] ' onClick={()=>setshow(prev=>!prev)}/>}
                   {show &&<FaRegEyeSlash className='w-[20px] absolute right-[5%]' onClick={()=>setshow(prev=>!prev)} />}
                     ...
                     <p className='flex gap-[10px]'>You have a account?<span className='text-blue-700 font-bold cursor-pointer' onClick={()=>navigate("/login")}>Login</span></p>
                </div>
