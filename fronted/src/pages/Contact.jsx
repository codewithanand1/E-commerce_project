      ...
      <Tittle text1={"CONTACT"} text2={"US"}/>
        <div className='w-[100%] flex items-center justify-center flex-col lg:flex-row'>
          ...
          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px] '>
            <p className=''>12345 Randon Station</p>
            <p className=''>random city,state ,India</p>
          </p>


          <p className='lg:w-[80%] w-[100%] text-[white] md:text-[16px] text-[13px] '>
            <p className=''>tel:+91-89697856789</p>
            <p className=''>Email:admin@oncart.com</p>
          </p>
          ...
          <button className='px-[30px] py-[20px] flex items-center justify-center text-[white] bg-transparent border actice:bg-slate-600 rounded-md'>Explore Jobs</button>
          </div>
        </div>
        <NewLetterBox/>
    </div>
